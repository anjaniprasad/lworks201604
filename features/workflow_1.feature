...
#      | ratio_table_300          |
  ...
  Scenario: Verify able to add new Monthly Utilization for Aircraft
    ...
    Then verify that Assembly Utilizations are auto created
      | Report Item Type          | Running Hours During Month | Cycles During Month |
      | APU                       | 300.00                     | 50                  |
      | Engine 1                  | 300.00                     | 50                  |
      | Engine 2                  | 300.00                     | 50                  |
      | Landing Gear - Left Main  | 300.00                     | 50                  |
      | Landing Gear - Right Main | 300.00                     | 50                  |
...
#      | 200                        | 25                  |
  ...
  it doesn't update Assembly FH & FC which was updated in Assembly utilization.
    ...
    Then verify that Assembly Utilizations are auto created
      ...
      | Engine 1                  | 400.00                     | 75                  |
      | Engine 2                  | 400.00                     | 75                  |
      | Landing Gear - Left Main  | 400.00                     | 75                  |
      | Landing Gear - Right Main | 400.00                     | 75                  |
